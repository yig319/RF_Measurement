...
def main(input_folder, output_folder):
    ...
    print(f"Saving file to: {os.path.join(output_folder, 'results.h5')}")
    ...
    plt.tight_layout()
    print(f"Saving file to: {os.path.join(output_folder, 'Qfactor.png')}")
    plt.savefig(os.path.join(output_folder, 'Qfactor.png'))
    print("File saved successfully")
    plt.close()
    # plt.show()
    ...
    plt.tight_layout()
    print(f"Saving file to: {os.path.join(output_folder, 'Capacitance.png')}")
    plt.savefig(os.path.join(output_folder, 'Capacitance.png'))
    print("File saved successfully")
    plt.close()
    # plt.show()
    ...
    plt.tight_layout()
    print(f"Saving file to: {os.path.join(output_folder, 'Conductance.png')}")
    plt.savefig(os.path.join(output_folder, '/Conductance.png'))
    print("File saved successfully")
    plt.close()
    # plt.show()
    ...
    plt.tight_layout()
    print(f"Saving file to: {os.path.join(output_folder, 'Tunability.png')}")
    plt.savefig(os.path.join(output_folder, 'Tunability.png'))
    print("File saved successfully")
    plt.close()
    # plt.show()
    ...
    plt.tight_layout()
    print(f"Saving file to: {os.path.join(output_folder, 'Other_plots.png')}")
    plt.savefig(os.path.join(output_folder, 'Other_plots.png'))
    print("File saved successfully")
    plt.close()
    # plt.show()
    ...
    plt.tight_layout()
    print(f"Saving file to: {os.path.join(output_folder, 'heatmaps.png')}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('input_folder', type=str, help='Path to the input folder containing S2P files')
    parser.add_argument('output_folder', type=str, help='Path to the output folder for results and plots')
