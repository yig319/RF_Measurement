...
params_calculation = analyzer.setup_params(folder_path='/app/datasets/LYW034BTONSO25nm-0D16F200V2S-J/S2P/')
results = analyzer.run_analysis()
save_dict_to_hdf5(results, '/app/datasets/LYW034BTONSO25nm-0D16F200V2S-J-results.h5')
...
plt.tight_layout()
plt.savefig('/app/output/Qfactor.png')
plt.close()
# plt.show()
...
plt.tight_layout()
plt.savefig('/app/output/Capacitance_conductance.png')
plt.close()
# plt.show()

fig, axes = plt.subplots(1, 3, figsize=(15, 4))
figure_generator.plot_lineplot(params_calculation['FreqS'], np.abs(results['QualityFactor'][:, results['BVI']]), 
...
figure_generator.plot_lineplot(params_calculation['FreqS'], np.abs(params_calculation['Y12r'][:, results['BVI']]), 
...
plt.tight_layout()
plt.savefig('/app/output/Tunability.png')
plt.close()
# plt.show()
...
figure_generator.s_parameter_lineplot(params_calculation['FreqS'], params_calculation['S11m'], voltages, 'S11', ylim=(results['S11min'], results['S11max']), ax=axes[1, 0])
figure_generator.s_parameter_lineplot(params_calculation['FreqS'], params_calculation['S21m'], voltages, 'S11', ylim=(results['S21min'], results['S21max']), ax=axes[1, 1])
plt.tight_layout()
plt.savefig('/app/output/Other_plots.png')
plt.close()
# plt.show()
...
plt.tight_layout()
plt.savefig('/app/output/heatmaps.png')
plt.close()
# plt.show()